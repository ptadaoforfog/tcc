...
function genSvg(char, utf8Hex) {
  ...
  <text x="50%" y="45%" font-family="Arial" font-size="50" fill="black" dominant-baseline="middle" text-anchor="middle">${char}</text>
  <text x="50%" y="75%" font-family="Arial" font-size="20" fill="black" dominant-baseline="middle" text-anchor="middle">${utf8Hex}</text>
</svg>`
}
